...
namespace ADV01.EX02V2
{
...

    {
        ...
        #region Equals(object obj) ==> this is the default Equals (object) can not use the specific type 
        ...
        #region IEqatable<T> Impelement the Equals(Employee other) method from IEquatable<T> interface
        // This method is type safe and avoid boxing unboxing for value types
        // and improve performance when comparing objects of the same type
        // Also this method is used in collections and algorithms that require equality comparison
        // Use Specific Type (Employee) to compare
        public bool Equals(Employee? _emp)
        {
            if (_emp is not null)
            {
                return (this.Id == _emp.Id) && (this.Name == _emp.Name) && (this.Salary == _emp.Salary);
